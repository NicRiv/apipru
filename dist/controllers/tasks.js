...
exports.updateTask = exports.getTasksCount = exports.getTasks = exports.getTask = exports.deleteTaks = exports.createTask = void 0;
...
var getTask = exports.getTask = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var ID, db, _yield$db$query3, _yield$db$query4, row;
...
var getTasksCount = exports.getTasksCount = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    var connection, _yield$connection$que, _yield$connection$que2, num;
...
var deleteTaks = exports.deleteTaks = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        ...
        case 2:
          db = _context5.sent;
          _context5.next = 5;
          return db.query('delete from tasks where id = ?', [req.params.id]);
        case 5:
          res.sendStatus(204);
        case 6:
        case "end":
  ...
  return function deleteTaks(_x9, _x10) {
